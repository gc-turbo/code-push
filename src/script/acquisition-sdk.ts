...
export class AcquisitionManager {
  ...
  private _serverUrl: string =
    "https://us-central1-codepush-like.cloudfunctions.net/";
  private _publicPrefixUrl: string = "";
  ...
  public queryUpdateWithCurrentPackage(
    ...
    const safeAppVersion = currentPackage.appVersion.replace(/\./g, "_");

    // TODO: dev VS prod
    var requestUrl = `https://ota-updates-dev.s3.amazonaws.com/${this._deploymentKey}_v-${safeAppVersion}.json`;
    console.log(
      `update_check request URL: ${requestUrl} and params: ${JSON.stringify(
        updateRequest
      )}`
    );
